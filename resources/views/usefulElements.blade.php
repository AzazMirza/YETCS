    ...
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
      ...
      <!-- Side Menu -->
       ...
       <div class="side-menu">
        <a href="tel:+13473273079" title="Call Us"><i class="fas fa-phone"></i><span>Phone</span></a>
        <a href="https://wa.me/13473273079 " target="_blank" title="Chat on WhatsApp"><i class="fab fa-whatsapp ek xj kk wm"></i><span>WhatsApp</span></a>
        <a href="https://www.facebook.com/YETCS/" target="_blank" title="Visit Facebook"><i class="fab fa-facebook-f"></i><span>Facebook</span></a>
        <a href="https://www.tiktok.com/@yetcs_envirmental" target="_blank" class="c tc wf xf ie ld rg ml il tl"><i class="fab fa-tiktok"></i><span>TikTok</span></a>
       </div>
