...
@section('page')
 <body
  x-data="{ page: 'the importance of Mold remediation Protecting your health and property', 'darkMode': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }"
    x-init="
