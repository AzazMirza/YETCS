...
@section('page')
  <body
    x-data="{ page: 'Lead Paint & Asbestos Hidden Hazards in Brooklyn’s Residential & Commercial Properties', 'darkMode': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }"
    x-init="
