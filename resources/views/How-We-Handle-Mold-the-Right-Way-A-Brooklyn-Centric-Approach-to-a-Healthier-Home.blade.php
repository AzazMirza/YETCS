...
@section('page')
  <body
    x-data="{ page: 'How We Handle Mold the Right Way A Brooklyn Centric Approach to a Healthier Home', 'darkMode': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }"
    x-init="
